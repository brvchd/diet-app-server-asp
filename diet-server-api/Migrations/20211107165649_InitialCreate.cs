        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    servingsizeingramms = table.Column<int>(type: "integer", nullable: false),
                    homemeasure = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    pal = table.Column<decimal>(type: "numeric(3,2)", precision: 3, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    datetoinformaboutchanges = table.Column<DateTime>(type: "date", nullable: true),
                    numberofmealsperday = table.Column<int>(type: "integer", nullable: false),
                    totalamountofcalories = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("foodinput_pk", x => x.idinput);
                    table.ForeignKey(
                        name: "foodinput_patient",
                        column: x => x.idpatient,
                        principalTable: "patient",
                        principalColumn: "iduser",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "foodinput_products",
                        column: x => x.idproduct,
                        principalTable: "product",
                        principalColumn: "idproduct",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    idmeasurement = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    idpatient = table.Column<int>(type: "integer", nullable: false),
                    height = table.Column<decimal>(type: "numeric(4,1)", precision: 4, scale: 1, nullable: false),
                    weight = table.Column<decimal>(type: "numeric(4,1)", precision: 4, scale: 1, nullable: false),
                    date = table.Column<DateTime>(type: "date", nullable: false),
                    hipcircumference = table.Column<decimal>(type: "numeric(4,1)", precision: 4, scale: 1, nullable: false),
                    waistcircumference = table.Column<decimal>(type: "numeric(4,1)", precision: 4, scale: 1, nullable: false),
                    bicepscircumference = table.Column<int>(type: "integer", nullable: true),
                    chestcircumference = table.Column<int>(type: "integer", nullable: true),
                    thighcircumference = table.Column<int>(type: "integer", nullable: true),
                    calfcircumference = table.Column<int>(type: "integer", nullable: true),
                    waistlowercircumference = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    excercisingperday = table.Column<decimal>(type: "numeric(3,2)", precision: 3, scale: 2, nullable: false),
                    sporttypes = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                    exercisingperweek = table.Column<decimal>(type: "numeric(3,2)", precision: 3, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("questionary_pk", x => x.idquestionary);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    diet_iddiet = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    idproduct_diet = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    idproduct = table.Column<int>(type: "integer", nullable: false),
                    iddiet = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("productdiet_pk", x => x.idproduct_diet);
                    table.ForeignKey(
                        name: "table_16_diet",
                        column: x => x.iddiet,
                        principalTable: "diet",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    idindividualrecipe = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    idrecipe = table.Column<int>(type: "integer", nullable: false),
                    proportion = table.Column<int>(type: "integer", nullable: false),
                    idmealtake = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_foodinput_idpatient",
                table: "foodinput",
                column: "idpatient");

            migrationBuilder.CreateIndex(
                name: "IX_foodinput_idproduct",
                table: "foodinput",
                column: "idproduct");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_productdiet_iddiet",
                table: "productdiet",
                column: "iddiet");

            migrationBuilder.CreateIndex(
                name: "IX_productdiet_idproduct",
                table: "productdiet",
                column: "idproduct");

            migrationBuilder.CreateIndex(
                name: "IX_questionary_idpatient",
                table: "questionary",
                column: "idpatient");
